...
wget https://raw.githubusercontent.com/Yarny998/MPD-Jesse-Lite/master/Packages/AlsaEqual/.alsaequal.bin.std

# Install files
install -D -m644 asound.conf "/etc/asound.conf"
install -D -m644 .alsaequal.bin.std "/var/lib/mpd/.alsaequal.bin.std"

#Cleanup
rm asound.conf
rm .alsaequal.bin.std
